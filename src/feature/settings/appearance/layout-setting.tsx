...
import { SidebarCollapsible, SidebarVariant } from '@/lib/layout-preferences';
...
const ProfileLayoutSetting = ({ variant, collapsible }: LayoutControlsProps) => {
    const handleValueChange = async (key: string, value: string) => {
        await setValueToCookie(key, value);
    };
    return (
        <div className="flex flex-col gap-5 bg-gray-100 dark:bg-background/10 pb-5 rounded-lg">
...
export default ProfileLayoutSetting